...
def define_Model(opt):
    ...
    if model == 'plain':
        ...
        from models.model_transformer import ModelTransformer as M

    elif model == 'mem_transformer': 
        from models.transformer_memory.model_memory import ModelMemFormer as M

    elif model == 'ModelPretrain': 
        from models.pretrain.model_pretrain import ModelPretrain as M

    elif model == 'dense_mem':
        from models.dense_memory.model_dense_memory import ModelMemDenseFormer as M
