...
def define_Dataset(dataset_opt):
    ...
    # SDR2HDR
    # -----------------------------------------
    elif dataset_type in ['videorecurrenttrainsdr2hdrdataset']:
        from data.dataset_video_train import YouTubeDataset as D
    elif dataset_type in ['videorecurrenttestsdr2hdrdataset']:
        from data.dataset_video_test import YouTubeTestDataset as D
