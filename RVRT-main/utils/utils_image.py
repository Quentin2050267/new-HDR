...
def calculate_psnr(img1, 
                   ...
                   border=0, 
                   in_type=np.uint8):
    # img1 and img2 have range [0, 255] or [0, 1]
    #img1 = img1.squeeze()
    #img2 = img2.squeeze()
    ...
    elif in_type == np.float32 or in_type == np.float64:
...
# SSIM
# --------------------------------------------
def _ssim(img1, img2, in_type=np.uint8):

    if in_type == np.float32 or in_type == np.float64:
        C1 = (0.01 * 1)**2
        C2 = (0.03 * 1)**2
    elif in_type == np.uint8:
        C1 = (0.01 * 255)**2
        C2 = (0.03 * 255)**2
...
def calculate_ssim(img,
    ...
    for i in range(img.shape[2]):
        ssims.append(_ssim(img[..., i], img2[..., i], in_type=in_type))
